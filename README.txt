...
As I say, this repository contains code, which was written to read ID3v2 tags from mp3 files. More about ID3v2 tags you can read in Internet (bur I think, that if you read it, you don`t  need to learn about ID3 tags). 
